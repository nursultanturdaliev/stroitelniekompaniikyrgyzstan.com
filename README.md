...
В репозитории **нет** автоматического GitHub Action на полный `data:refresh` после обновления выгрузки: при коммите нового `merged-companies.json` в свой процесс деплоя добавьте эти шаги или выполняйте их локально перед публикацией.
